...
/*			String portNo = JOptionPane.showInputDialog("Enter the port number to connect to:", "2009");
	...
	private class ClamLabel extends JLabel implements MouseListener {
		...
		// put the code in hear into a separate thread
		public void mouseClicked(MouseEvent e) {
			int button = e.getButton();
			if(e.getMouseModifiersText(e.getModifiers()).startsWith("Shift"))
			{
				button = sPearl;
			}
